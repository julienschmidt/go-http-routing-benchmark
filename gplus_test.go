...
func init() {
	...
	calcMem("NanoMux", func() {
		gplusNanoMux = loadNanoMux(gplusAPI)
	})
	calcMem("Pat", func() {
...
func BenchmarkNanoMux_GPlusStatic(b *testing.B) {
	req, _ := http.NewRequest("GET", "/people", nil)
	benchRequest(b, gplusNanoMux, req)
}
...
func BenchmarkNanoMux_GplusParam(b *testing.B) {
	req, _ := http.NewRequest("GET", "/people/118051310819094153327", nil)
	benchRequest(b, gplusNanoMux, req)
}
...
func BenchmarkNanoMux_GPlus2Params(b *testing.B) {
	req, _ := http.NewRequest("GET", "/people/118051310819094153327/activities/123456789", nil)
	benchRequest(b, gplusNanoMux, req)
}
...
func BenchmarkNanoMux_GPlusAll(b *testing.B) {
	benchRoutes(b, gplusNanoMux, gplusAPI)
}
